...
public:
	 ...
	 *
	 * Критерии: длина слова в промежутке [0;256] и является корректным идентификатором языка C++, т. е. начинается с буквы латиницы, кириллицы или символа _, а все другие символы являются буквами латиницы, кириллицы, символами _ или цифрами
	 */
