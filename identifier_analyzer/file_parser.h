...
public:
	...
	/** Возвращает имена и количество ключевых (зарезервированных) слов */
	auto get_reserved_words() const { return reserved_words.get_identifiers(); }

	/** Возвращает имена и количество не ключевых (не зарезервированных) слов */
...
private:
	...
	/** Разделяет слова на ключевые и не ключевые и добавляет их в соответствующие списки */
